...
class LiveFaceDetection extends StatefulWidget {
  const LiveFaceDetection({super.key});
...
class _LiveFaceDetectionState extends State<LiveFaceDetection> {
  ...
  CameraLensDirection camDirection = CameraLensDirection.back;
  ...
  performFaceRecognition(List<Face> faces) async {
    ...
    image = img.copyRotate(image!,
        angle: camDirection == CameraLensDirection.front ? 270 : 90);
  ...
  showFaceRegistrationDialogue(img.Image croppedFace, Recognition recognition) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Text("Face Registration", textAlign: TextAlign.center),
  ...
  InputImage? getInputImage() {
    final camera =
        camDirection == CameraLensDirection.front ? cameras![1] : cameras![0];
  ...
  buildResult() {
    ...
    CustomPainter painter =
        FaceDetectorPainter(imageSize, _scanResults, camDirection);
    return CustomPaint(
      painter: painter,
    );
  }
